        ...
        <div className="cover_background">
          <div className="flex">
            <div className="unctad_logo_container">
              <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2022-a_double_burden/' : './'}assets/img/unctad_logo_white.svg`} alt="UNCTAD logo" />
            </div>
        ...
        <div className="content_container">
          ...
          <ul>
            ...
            <li>
              ...
              {' '}
              <span className="not_highlight">can help to increase the availability and affordability of food worldwide. To this end, all parties should support the agreements signed in Istanbul, Türkiye, last July:</span>
              <ol>
                <li>
